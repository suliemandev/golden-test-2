    ...
    <nav class="bg-transparent relative w-full z-10">
                ...
                <div class="flex-1 flex items-center justify-center lg:items-stretch lg:justify-start">
                    ...
                    <div class="hidden lg:block lg:ms-6">
                        <div class="flex">
                            ...
                            <a href="#about" @click="$scrollTo('#about')" class="ms-4 px-3 py-2 rounded-md leading-5 text-gray-800 hover:text-white hover:bg-gray-900 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">
                                {{ __('About') }}
                            </a>
                            <a href="#contact" @click="$scrollTo('#contact')" class="ms-4 px-3 py-2 rounded-md leading-5 text-gray-800 hover:text-white hover:bg-gray-900 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">
                                {{ __('Contact') }}
                            </a>
                        </div>
                    </div>
        ...
        <div :class="{'max-h-screen': showMobileNavigation}" class="max-h-0 overflow-hidden transition-all duration-500 ease-out-in">
            <div class="px-2 pt-2 pb-3">
                ...
                <a href="#about"  @click="$scrollTo('#about')" class="mt-1 block px-3 py-2 rounded-md text-base text-gray-600 hover:text-white hover:bg-gray-900 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">
                    {{ __('About') }}
                </a>
                <a href="#contact"  @click="$scrollTo('#contact')" class="mt-1 block px-3 py-2 rounded-md text-base text-gray-600 hover:text-white hover:bg-gray-900 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">
                    {{ __('Contact') }}
                </a>
            </div>
        </div>
