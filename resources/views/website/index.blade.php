	...
	<particle 
        ...
        <div class="p-4 h-full items-center justify-center flex flex-col">
            ...
            <div class="flex items-center justify-center mb-16 mt-7 lg:mt-10">
                ...
                <a href="#quiz" class="cursor-pointer bg-black border-2 border-black flex flex-shrink-0 h-16 items-center justify-center me-4 sm:me-6 relative rounded-full w-16 z-10 text-yellow-500 hover:text-white">
                ...
                <a href="#quiz" @click.prevent="scrollTo('#quiz')" class="border-2 border-black flex-shrink-0 focus:outline-none hover:bg-black hover:text-white font-semibold px-6 sm:px-10 py-3 rounded-full text-black text-lg z-10">
                    {{ __('Start') }}
                </a>
            </div>
        </div>
