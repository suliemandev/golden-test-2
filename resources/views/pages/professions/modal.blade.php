			...
			<div class="modal-content">
				...
				<div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="title_en" data-json="title" placeholder="Profession English" class="form-control mb-2" required>
                        <input type="text" name="title_he" data-json="title" placeholder="התמחות בעברית" class="form-control mb-2" required>
		                ...
		                <select class="form-control" name="trendID" required>
		                    ...
		                    <option value="{{$trend->id}}">{{ $trend->title['en'] }}</option>
		                    @endforeach
		                </select>
                    </div>
				</div>
